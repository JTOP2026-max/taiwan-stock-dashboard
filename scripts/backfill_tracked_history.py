...
S = requests.Session()
S.headers.update({'User-Agent':'Mozilla/5.0 TaiwanStockDashboard/3.1'})
TRACKED = ['3008','6510','3044','2454','6274']
MONTHS = 14
